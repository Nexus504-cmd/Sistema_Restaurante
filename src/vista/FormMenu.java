...
public class FormMenu extends javax.swing.JFrame {
    ...
    private DefaultTableModel verSopas() {
        ...
        String sql = "select id_producto, nombre, tipo, precio from mostrarproductos where tipo = 'Sopa' and estado = 'true'";
    ...
    private DefaultTableModel verSegundos() {
        ...
        modelo.addColumn("Tipo");
        modelo.addColumn("Precio");
        String sql = "select id_producto, nombre, tipo, precio from mostrarproductos where tipo = 'Segundo' and estado = 'true'";
        try (Connection conn = Conexion.getConexion(); PreparedStatement stmt = conn.prepareStatement(sql)) {
    ...
    private DefaultTableModel verBebidas() {
        ...
        modelo.addColumn("Tipo");
        modelo.addColumn("Precio");
        String sql = "select id_producto, nombre, tipo, precio from mostrarproductos where tipo = 'Bebida' and estado = 'true'";
        try (Connection conn = Conexion.getConexion(); PreparedStatement stmt = conn.prepareStatement(sql)) {
